...
const CardSkeleton = () => {
  return (
    <div className="relative flex w-full animate-pulse flex-col items-center gap-4 rounded-2xl rounded-2xl border-2 border-zinc-300 pt-4 dark:border-0 dark:bg-slate-800">
